...
\author{\sf{\Large\textbf{ Shabarish Sai Subramanian}\\\large Masters in Business Analytics\\[0.5cm]}{\Large\textbf{ Priyasha Saini}\\\large Masters in Business Analytics\\[0.5cm]}}

\date{\sf\Date~\Month~\Year}
\makeatletter
\lfoot{\sf Shabarish Sai Subramanian, Priyasha Saini: \@date}
\makeatother
